...
% 1 Información del Documento %
\newcommand{\tfgtitlename}{Diseño e implementación 
 de un procesador RISC-V}
\newcommand{\tfgtitlenameENG}{Design and Implementation of a RISC-V Processor}
\newcommand{\tfgauthorname}{Xiangmin Fan}
\newcommand{\tfgtutorname}{Rodríguez Fernández Juan Antonio}
\newcommand{\tfganno}{2025}
